...
if ($table_exists) {
    echo "<div class='info'>Dropping existing courses table to ensure clean structure...</div>";
    if ($conn->query("DROP TABLE courses") === TRUE) {
...
// Step 3: Insert comprehensive course data
echo "<div class='step'>";
...
if ($error_count == 0) {
    ...
    echo "• Sample courses from all training categories<br>";
